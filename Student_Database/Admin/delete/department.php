...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method = "POST" action = "depdel.php">
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Delete Department  </h2><br/>
      <input type="text" placeholder="Department ID" name = "id"/>

	  
      <button type = "id"><a>Delete</button>
         </form>
  </div>
	</div>
