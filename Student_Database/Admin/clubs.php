...
<?php
	...
	if($resultCheck == 0){
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			$club_head = $row['club_head'];
			$sql1 = "SELECT * FROM faculty WHERE fac_id = '$club_head'";
...
<div class="form">
    ...
    <form class="login-form">
	  <br/>
      <button><a href="forms/club.php"><b>Insert</button></a><br/><br/>
	  <button><a href="delete/club.php"><b>Delete</button></a><br/><br/>
