...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method = "POST" action = "clubins.php">
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Club Registration </h2><br/>
      <input type="text" placeholder="Club ID" name = "club_id"/>
	  <input type="text" placeholder="Name" name = "club_name"/>
	  <input type="text" placeholder="Head" name = "club_head"/>
