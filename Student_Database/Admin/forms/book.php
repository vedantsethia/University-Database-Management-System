...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method = "POST" action = "bookins.php">
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Book Registration </h2><br/>
      <input type="text" placeholder="Book ID" name = "book_id"/>
	  <input type="text" placeholder="Name" name = "book_name"/>
	  <input type="text" placeholder="Author" name = "author"/>
	  <input type="text" placeholder="Library ID" name = "lib_id"/>
	  
      <button><type = "submit"><a>Register</button></a>
         </form>
  </div>
	</div>
