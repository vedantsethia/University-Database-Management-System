...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method = "POST" action = "courseins.php">
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Course Registration </h2><br/>
	  ...
	  <input type="text" placeholder="Credits" name = "credits"/>
		<input type="text" placeholder="Textbook ID" name = "text_id"/>
		<input type="text" placeholder="Faculty" name = "fac_id"/>
	  		<input type="text" placeholder="Room no" name = "room_no"/>
