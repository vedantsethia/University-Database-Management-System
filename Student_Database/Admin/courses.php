...
<?php
	...
	echo "<center><h2><u>COURSES</u></h2></center>";
	if($resultCheck == 0){
		echo "There are no courses in the database.";
	}
	else{
...
<div class="form">
    ...
    <form class="login-form">
	  <br/>
      <button><a href="forms/course.php"><b>Insert</button></a><br/><br/>
	  <button><a href="delete/course.php"><b>Delete</button></a><br/><br/>
