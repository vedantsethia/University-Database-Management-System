...
body {
  ...
  -moz-osx-font-smoothing: grayscale;     */
   ...
   background-size:cover;
	background-image: url('universiy.jpg');
}
...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method = "POST" action = "takeup.php">
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Course  </h2><br/>
      <input type="text" placeholder="Course ID" name = 'id'/>

	  
      <button type = 'submit'><a>Take UP</button>
         </form>
  </div>
	</div>
	<?php
		...
		if($resultCheck == 0){
			echo "Students takes no courses.";
		}
		else{
