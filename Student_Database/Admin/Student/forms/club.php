...
body {
  ...
  -moz-osx-font-smoothing: grayscale;     */
   ...
   background-size:cover;
	background-image: url('univesity.jpg');
}
...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method = "POST" action = "part.php">
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Club  </h2><br/>
      <input type="text" placeholder="Club ID" name = 'id'/>

	  
      <button type = 'submit'><a>Join</button>
     </form>
  </div>
	</div>
	<?php
