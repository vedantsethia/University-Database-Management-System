...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" method ="POST" action = 'works.php'>
		<img src="student.png" height=50px width=70px alt="Hey ! Good Looking">
		<h2 class="h"> Project </h2><br/>
      <input type="text" placeholder="Project ID" name = 'id'/>
...
<?php
	...
	if($resultCheck == 0){
		echo "There are no projects in the database.";
	}
	else{
